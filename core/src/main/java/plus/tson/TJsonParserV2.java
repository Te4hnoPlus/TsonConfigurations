 ...
 * </pre>
 */
public final class TJsonParserV2 extends ByteStrBuilder{
    private final boolean objMode;
    private final byte[] data;
    private int cursor = 0;

    public TJsonParserV2(final String str) {
        this(str.getBytes(StandardCharsets.UTF_8), true);
    }


    public TJsonParserV2(final String str, final boolean objMode) {
        this(str.getBytes(StandardCharsets.UTF_8), objMode);
    }


    public TJsonParserV2(final byte[] data, final boolean objMode) {
        super(16);
