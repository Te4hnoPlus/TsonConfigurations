...
public class Te4HashMap<K,V> implements Map<K,V>, Cloneable, Serializable {
    ...
    public Te4HashMap(int initialCapacity) {
    ...
    public final Node<K,V> putN(K key, V value) {
        return putValN(hash(key), key, value, false, true);
    }
    ...
    final V putVal(int hash, K key, V value, boolean onlyIfAbsent,
                   boolean evict) {
        Node<K, V> node = putValN(hash, key, value, onlyIfAbsent, evict);
    ...
    protected final Node<K,V> removeNode(int hash, Object key, Object value,
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public final void clear()               { Te4HashMap.this.clear(); }
        ...
        public final Spliterator<K> spliterator() {
            return new KeySpliterator<>(Te4HashMap.this, 0, -1, 0, 0);
        }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public final Spliterator<V> spliterator() {
            return new ValueSpliterator<>(Te4HashMap.this, 0, -1, 0, 0);
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K,V>> {
        ...
        public final Spliterator<Map.Entry<K,V>> spliterator() {
            return new EntrySpliterator<>(Te4HashMap.this, 0, -1, 0, 0);
        }
...
*/
    ...
    static final class KeySpliterator<K,V>
        ...
        KeySpliterator(Te4HashMap<K,V> m, int origin, int fence, int est,
                       int expectedModCount) {
    ...
    static final class ValueSpliterator<K,V>
        ...
        ValueSpliterator(Te4HashMap<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class EntrySpliterator<K,V>
        ...
        EntrySpliterator(Te4HashMap<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
